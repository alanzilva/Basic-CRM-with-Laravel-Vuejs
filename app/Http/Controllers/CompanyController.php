    ...
    public function store(Request $request)
    {
        ...
        if($create) {
            ...
            return response()->json([
                'success' => trans('Company has been successfully created!')
            ]);
        } else {
            //return with error
            return response()->json([
                'error' => trans('Company could not be created!')
            ]);
        }
    }
...
//        $this->authorize('update', Company::find($id));
        ...
        if($update) {
            //return with success
            return response()->json([
                'success' => trans('Company has been successfully updated!')
            ]);
        } else {
            //return with error
            return response()->json([
                'error' => trans('Company could not be updated!')
            ]);
        }
    }
